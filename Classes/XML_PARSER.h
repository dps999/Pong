...
private:
   ...
   //
   void Grab_Node_Informations(IXMLDOMNodePtr pChild);            // Grab all eficients informations about a MSXML Node
   HRESULT Is_MSXML_Node(IXMLDOMNodePtr pChild);                  // Return NULL,NODE_ELEMENT,NODE_TEXT or NODE_CDATA_SECTION
